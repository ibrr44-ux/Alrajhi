...
* services: ${services}
* reliability: ${f.reliability_classification || 'غير محدد'}`;
  }).join('\n\n');
...
مهمتك:
إنتاج مقارنة مهنية وعملية تساعد المريض على اختيار المركز الأنسب لحالته الصحية الفعلية من بين المراكز الطبية المقارنة (${facilities.length} مراكز)، وليس الأعلى تسويقًا أو شهرة فقط.

━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
GLOBAL EXECUTION RULES
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━

1. استخدم فقط البيانات المقدمة داخل المدخلات.
2. لا تخترع معلومات غير موجودة.
3. لا تستخدم لغة تسويقية أو دعائية.
4. ركّز على ملاءمة كل مركز للمشكلة الصحية المحددة، وليس التقييم العام فقط.
5. عند ضعف الأدلة أو انخفاض الثقة يجب التصريح بذلك بوضوح.
6. التحليل يجب أن يكون طبيًا عمليًا ومبسطًا للمريض العادي.
7. أخرج الإجابة باللغة العربية الفصحى المبسطة.
8. نظّم الإجابة بالأقسام المطلوبة فقط.

━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
REPUTATION NOISE FILTERING ENGINE
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━

قبل تنفيذ المقارنة النهائية، قم بتصفية الضوضاء والانحيازات غير الطبية في السمعة.

لا تعتمد على المراجعات التالية كمؤشر حقيقي للجودة السريرية:

## [N1] Courtesy Reviews (المجاملات الاجتماعية)
المراجعات التي تحتوي فقط على تعامل راقي، أخلاق ممتازة، استقبال جميل، إلخ، بدون تفاصيل طبية أو نتائج علاجية فعلية.
→ تعامل كـ "ضعيفة التأثير السريري".

## [N2] Promotional Reviews (التلميع التجاري)
مراجعات ترويجية قصيرة بدون تفاصيل علاجية تبالغ بذكر الطبيب أو المركز.
→ خفّض وزنها بشدة في التحليل.

## [N3] Competitive Smear Reviews (التشويه التنافسي)
مراجعات هجومية عاطفية بدون تفاصيل موضوعية.
→ لا تعتبرها دليلاً موثوقاً إلا بوجود مراجعات مستقلة متعددة تدعمها.

## [N4] Non-Clinical Bias
لا تجعل عناصر مثل شكل الديكور، القهوة، المواقف، أو الشهرة على السوشيال ميديا تؤثر على التقييم الفني.

━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
NOISE IMPACT RULES
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
* أعطِ الأولوية للمراجعات التي تحتوي وصف المشكلة ونتيجة العلاج.
* إذا كانت السمعة مبنية على مجاملات، اذكر ذلك بوضوح.
...
## [A] Clinical Relevance Analysis
ملاءمة كل مركز للمشكلة المحددة (التخصص، نوع الحالات، السمعة العلاجية، خبرة الكادر).

## [B] Reputation Reliability Assessment
موثوقية السمعة لكل مركز (الأدلة المؤهلة، مستوى الثقة، ثبات السمعة).

## [C] Practical Patient Factors
عوامل عملية للمريض (سهولة الوصول، سرعة بدء العلاج، ملائمة الحالات المعقدة).

━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
NUMERICAL EVALUATION SYSTEM
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━

قيّم كل من المراكز المقارنة من 1 إلى 10 في:
1. الجودة السريرية
...
DECISION LOGIC
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
* أعط أولوية للمراكز الأكثر تخصصاً وثقة في نوع المشكلة المعروضة.
* أي مركز ثقته أقل من 70 أو يحتاج تحققاً إضافياً يجب التنبيه عليه بوضوح.

━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
FINAL OUTPUT STRUCTURE
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━

أخرج النتيجة بالأقسام التالية حصراً:

# أولاً: التحليل الطبي للمشكلة
* أي المراكز المقارنة يبدو أكثر ملاءمة للحالة؟ ولماذا؟
* تفصيل لنقاط القوة والضعف لكل مركز بالنسبة لهذه الحالة تحديداً.

# ثانياً: التقييم الرقمي للمراكز
${facilities.map((f, i) => {
...
# ثالثاً: التوجيه المناسب للمريض
* توصية عملية وواضحة تحدد متى يذهب المريض لكل مركز ونوع الحالات الأنسب لكل منها.
